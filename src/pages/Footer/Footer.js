...
import { FaFacebook, FaGoogle, FaGithub, FaGit } from 'react-icons/fa';
const Footer = () => {
    return (
        <div className='mt-10'>
            <footer className="footer items-center p-4 bg-neutral text-neutral-content justify-center place-items-center">
                ...
                <div>
                    <h6 className='text-base'>Wedding Photography</h6>
                </div>
